        ...
        >
          ...
          >
            ...
            <Link
              ...
              className={
                !isWindowSizeSmall
                  ? "h-10 w-fit rounded-full flex items-center justify-center text-center hover:dark:bg-slate-800 hover:bg-slate-200 border-4 border-solid border-slate-200 dark:border-slate-800 px-4 cursor-pointer"
                  : "h-fit w-fit rounded-full flex items-center justify-center text-center hover:dark:bg-slate-800 hover:bg-slate-200 border-4 border-solid border-slate-200 dark:border-slate-800 cursor-pointer px-4 py-2"
              }
            >
              <p className="text-sm">
